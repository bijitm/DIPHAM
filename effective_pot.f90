      subroutine effective_pot (r,theta,phi,xi,omega,delta,dipole,veff)
        ...
        ! PRL 130, 183001 (2023)
        use constants, only: Debye_in_au, hartree_to_inv_cm, &
                MHz_to_inv_cm
        implicit none
        ...
        c3 = (dipole*Debye_in_au)**2*hartree_to_inv_cm/ &
                (12d0*(1d0+del_r**2))
        c6 = ((dipole*Debye_in_au)**2*hartree_to_inv_cm)**2/ &
                (8d0*omega*MHz_to_inv_cm*sqrt((1d0+del_r**2)**3))
